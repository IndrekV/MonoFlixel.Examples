...
namespace MonoFlixel.Examples
{
	...
	public class ModePlayState : FlxState
	{
		protected String ImgTech = "Mode/tech_tiles.png";
		protected String ImgDirtTop = "Mode/dirt_top.png";
		protected String ImgDirt = "Mode/dirt.png";
		protected String SndMode = "Mode/mode.mp3";
		protected String SndCount = "Mode/countdown.mp3";
		private String ImgGibs = "Mode/gibs.png";
		private String ImgSpawnerGibs = "Mode/spawner_gibs.png";
		private String ImgMiniFrame = "Mode/miniframe.png";
